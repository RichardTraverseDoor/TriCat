    ...
    >
      ...
      <div class="flex flex-wrap items-center justify-between gap-8">
        <div class="max-w-xl space-y-3">
          <p class="text-sm uppercase tracking-[0.45em] text-emerald-200/70">TriCats Einkaufs-Helfer</p>
          ...
          <p class="text-emerald-100/70">
            Sammle deine Gerichte, hake Zutaten ab und schnapp dir, was dich oder deine Katze glücklich macht. Jede Liste ist ganz nach deinem Geschmack.
          </p>
        </div>
        <div class="flex flex-col items-end gap-4 text-right text-sm text-emerald-100/70">
          <div class="rounded-3xl border border-emerald-400/30 bg-slate-900/60 px-6 py-4">
            ...
            <p class="mt-2 text-lg font-semibold text-emerald-100">{{ activeList?.name ?? 'Noch keine Liste' }}</p>
